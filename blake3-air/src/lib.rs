...
mod tests {
    ...
    use p3_fri::{create_benchmark_fri_params, TwoAdicFriPcs};
    ...
    const LOG_TRACE_LENGTH: usize = 4;
    ...
    fn test_blake3_proving() {
        ...
        let val_mmcs = MerkleTreeMmcs::<
            ...
            SerializingHasher<Sponge>, KeccakCompressionFunction,
            4
        ...
        let trace = proof_goal.generate_trace_rows::<MontyField31<BabyBearParameters>>(trace_height, fri_params.log_blowup);
